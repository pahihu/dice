...
/* XXX LONG System( CONST_STRPTR command, CONST struct TagItem *tags ); */
LONG System( STRPTR command, CONST struct TagItem *tags );
/* XXX LONG SystemTags( CONST_STRPTR command, ULONG tag1type, ... ); */
LONG SystemTags( STRPTR command, ULONG tag1type, ... );
...
/* XXX BPTR NewLoadSegTags( CONST_STRPTR file, ULONG tag1type, ... ); */
BPTR NewLoadSegTags( STRPTR file, ULONG tag1type, ... );
...
/* XXX LONG Printf( CONST_STRPTR format, ... ); */
