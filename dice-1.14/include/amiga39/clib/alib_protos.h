...
/* XXX struct MsgPort *CreatePort( CONST_STRPTR name, LONG pri ); */
struct MsgPort *CreatePort( STRPTR name, LONG pri );
struct IOStdReq *CreateStdIO( CONST struct MsgPort *port );
/* XXX struct Task *CreateTask( CONST_STRPTR name, LONG pri, CONST APTR initPC, ULONG stackSize ); */
struct Task *CreateTask( STRPTR name, LONG pri, CONST APTR initPC, ULONG stackSize );
